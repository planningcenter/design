...
`data-horizontal-main-nav--link-augmenter` applies specified styles to link augmentations.

Markup should reflect the separation of the link and augmenter — allowing for discrete labeling.

**Example:**

This example provides a terse screen representation with a more verbose screen-reader presentation.

```html
<a data-horizontal-main-nav--link href="#">
  <span>Tasks</span>
  <span aria-label=", 3 new" data-horizontal-main-nav--link-augmenter> 3 </span>
</a>
```
    ...
    <SampleContainer>
      <div data-horizontal-main-nav--container>
        <nav data-horizontal-main-nav--link-group>
          <a data-horizontal-main-nav--link href="#">
            <span>Tasks</span>
            <span aria-label=", 3 new" data-horizontal-main-nav--link-augmenter>
              3
            </span>
          </a>
          <a data-horizontal-main-nav--link href="#">
